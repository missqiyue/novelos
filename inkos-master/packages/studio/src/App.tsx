...
import { GodEyeDashboard } from "./pages/GodEyeDashboard";
...
export function App() {
  ...
  const nav = {
    ...
    toGodEye: (bookId: string) => setRoute({ page: "godeye", bookId }),
  };
    ...
    <div className="h-screen bg-background text-foreground flex overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-background/30 backdrop-blur-sm">
        ...
        <main className="flex-1 relative overflow-y-auto scroll-smooth">
          ...
          {route.page === "godeye" && (
            <div className="max-w-[1400px] mx-auto px-6 py-12 md:px-12 lg:py-16 fade-in">
              <GodEyeDashboard bookId={route.bookId} nav={nav} />
            </div>
          )}
        </main>
      </div>
