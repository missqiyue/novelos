          ...
          {step === 1 && (
            <div className="mt-6 space-y-2">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/40 text-left text-sm"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/40 text-left text-sm"
              >
                <span className="flex items-center gap-2">
                  <Gift size={16} />
                  体验示例项目「星辰仙途」
