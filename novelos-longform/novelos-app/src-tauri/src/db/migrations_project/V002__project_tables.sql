...
CREATE VIRTUAL TABLE IF NOT EXISTS canon_rules_fts USING fts5(
    content,
    content='canon_rules',
    content_rowid='rowid',
    tokenize='unicode61'
...
CREATE VIRTUAL TABLE IF NOT EXISTS event_nodes_fts USING fts5(
    summary,
    content='event_nodes',
    content_rowid='rowid',
    tokenize='unicode61'
...
CREATE VIRTUAL TABLE IF NOT EXISTS reader_comments_fts USING fts5(
    content,
    content='reader_comments',
    content_rowid='rowid',
    tokenize='unicode61'
);
